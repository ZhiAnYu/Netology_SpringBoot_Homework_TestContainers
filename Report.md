# Отчет по выполнению задачи: Интеграционное тестирование Spring Boot приложения с использованием Testcontainers
...
*   **Фреймворк:** Spring Boot Web MVC (версия 3.5.10), Tomcat 11.0.18.
*   **Контейнеризация:** Docker Engine (версия 29.3.0).
*   **Базовый образ:** `eclipse-temurin:17-jre-alpine`(вместо openjdk:8-jdk-alpine)   
